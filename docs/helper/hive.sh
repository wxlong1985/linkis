...
cp -r linkis-engineconn-plugins/hive/target/out/hive $LINKIS_HOME/lib/linkis-engineconn-plugins/


cd $LINKIS_HOME
source ~/.bash_profile
./sbin/linkis-daemon.sh restart linkis-ps-publicservice
...
#cp  $LINKIS_HOME/lib/linkis-engineconn-plugins/hive/dist/3.1.2/lib/* $LINKIS_HOME/lib/linkis-public-enhancements/linkis-ps-publicservice/
